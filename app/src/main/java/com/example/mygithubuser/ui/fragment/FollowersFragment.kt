...
import com.example.mygithubuser.data.viewmodel.FollowersViewModel
...
class FollowersFragment: Fragment(R.layout.fragment_follow) {
    ...
    private fun showEmptyFollowersMessage() {
        binding.tvEmptyFollowers.visibility = View.VISIBLE
        binding.tvEmptyFollowers.text
    }
